...
import Security from "@/assets/svg/Security.json";
...
const Info = () => (
  <section className={`${styles.paddings} relative z-10`}>
    <motion.div
      ...
      className={`${styles.innerWidth} mx-auto flex lg:flex-row flex-col overflow-hidden mb-10`}
    >
      <motion.div
      ...
      >
        <div className="relative my-auto w-[80%] h-[80%] object-contain lg:-mt-6">
          {/* Lottie se carga solo en el cliente */}
